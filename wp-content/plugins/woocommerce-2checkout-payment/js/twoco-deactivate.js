...
jQuery(function($){
    ...
    var modal = $('#twoco-deactivate-modal');
    var deactivateLink = '';


    $('#the-list').on('click', 'a.twoco-deactivate-link', function (e) {
        e.preventDefault();
    ...
    $('#twoco-deactivate-modal').on('click', 'a.review-and-deactivate', function (e) {
        e.preventDefault();
    ...
    modal.on('click', 'button.pipe-model-submit', function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'twoco_submit_uninstall_reason',
